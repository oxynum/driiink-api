...
/**
 * @extends ServiceEntityRepository<Barman>
 *
 ...
 */
class BarmanRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
     ...
     */
    public function add(Barman $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Barman $entity, bool $flush = true): void
    {
